...
window.layer.TypingPublisher = TypingPublisher;
...
/**
 * Change which conversation the user is typing into
 *
 * @method
 * @param  {[type]} c [description]
 */
TypingPublisher.prototype.setConversation = function setConversation(c) {
...
TypingPublisher.prototype.setState = function setState(state) {
    if (this.pauseLoopId) {
...
TypingPublisher.prototype.startPauseLoop = function startPauseLoop() {
    if (this.pauseLoopId) {
        return;
...
TypingPublisher.prototype.scheduleNextMessage = function scheduleNextMessage(state) {
...
TypingPublisher.prototype.send = function send(state) {

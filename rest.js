...
(function() {
    ...
    function getNonce() {
        var d = new $.Deferred();
        $.ajax({
            url: sampledata.config.serverUrl + "/nonces",
            method: "POST",
    ...
    function getIdentityToken(nonce) {
        ...
        $.ajax({
            ...
            headers: {
                "X_LAYER_APP_ID": sampledata.config.appId,
                "Content-type": "application/json",
                "Accept": "application/json"
            },
            method: "POST",
            data: JSON.stringify({
                app_id: sampledata.config.appId,
    ...
    function getSession(identityToken) {
        var d = new $.Deferred();
        $.ajax({
            url: sampledata.config.serverUrl + "/sessions",
            method: "POST",
            headers: sampledata.headers,
            data: JSON.stringify({
    ...
    function createConversation(participants) {
        return $.ajax({
            url: sampledata.config.serverUrl + "/conversations",
            method: "POST",
            headers: sampledata.headers,
            data: JSON.stringify({
    ...
    function initiateRichContentUpload(mimeType, size) {
        return $.ajax({
            url: sampledata.config.serverUrl + "/content",
            method: "POST",
            headers: $.extend({
    ...
    function addRemoveParticipants(conversationUrl, addUsers, removeUsers) {
        ...
        return $.ajax({
            url: conversationUrl,
            method: "PATCH",
            headers: $.extend({}, sampledata.headers, {
